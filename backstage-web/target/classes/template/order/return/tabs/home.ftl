...
<div class="ibox">
    ...
    <#if message??>
        ...
        <div class="row">
            <div class="col-sm-12">
                <form id="searchForm" modelAttribute="dict" action="/order/return/tabs?queryType=1" method="post" class="form-inline">
               ...
               -->
                    <div class="form-group" style="width: 99%">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <textarea name="reverseIdList" id="reverseIdList" oninput="/^\d[;0-9]*$/.test(this.value)?this.value:this.value=this.value.replace(/[^;0-9]/g,'')" onkeyup="this.value=this.value.replace(/\D/g,'')" <#if reverseIdList??>value="${reverseIdList}"</#if>  class="form-control"></textarea>
                            </div>
                            <div class="col-md-1">
                                <span>申请单状态 ：</span>
                            </div>
                            <div class="col-md-3">
                                ...
                                <#if dictLists??>
                                    <#list dictLists as dict>
                                        <#if dict??>
                                        <option <#if dict.status??>value="${dict.status}"  <#if status??&&dict.status==status>selected</#if></#if> ><#if dict.names??>${dict.names}</#if>
                                                    </#if>
                                    </option>
                                    </#list>
                                </#if>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <#if b.operationName??&&b.operationName=='收货'>
                            ...
                            <shiro:hasPermission name="order:return:auditnot">
                                <#if b.operationName??> <a href="#" onclick="openDialog('审核退换货', '/order/return/form?reverseId=${b.reverseId?c}&flag=94','800px', '500px')" class="btn btn-danger btn-xs" ><i class="fa fa-trash"></i>  ${b.operationName}不通过</a></#if>
                            </shiro:hasPermission>
                        </#if>
                    </td>
                </tr>
