...
<#include "../../message.ftl">
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            <td  class="width-15 active">	<label class="pull-right">规则说明:</label></td>
            <td class="width-30" ><input name="" htmlEscape="false" maxlength="11" class="form-control required abc"/></td>
            <td  class="width-20 active">	</td>
        </tr>
        <tr>
            <td  class="width-15 active">	<label class="pull-right">规则说明:</label></td>
            <td class="width-30" ><input name="" htmlEscape="false" maxlength="11" class="form-control required digits"/></td>
            <td  class="width-20 active">	</td>
        </tr>
        ...
        <tr>
            ...
            <td class="width-30" ><input name="sBenefitValue" id="sBenefitValue" htmlEscape="false" maxlength="50" class="form-control" />（例：8折填0.8）</td>

        </tr>

        <tr>
            <td class="width-15 active">
                <label class="pull-right"><input id="isShow1" name="isShow" class="i-checks " type="radio" value="1" <label for="isShow1">满额:</label>
                </label>
                </span>
    ...
    <script>
        ...
        function updateProduct(){
            ...
            $.ajax({
                type: "post",
                url: "/json/product",
                data: "searchproductIds="+storeVal+"&searchstoreIds="+storeIds,
                dataType: 'html',
                contentType: "application/x-www-form-urlencoded; charset=utf-8",
                success: function(result) {
