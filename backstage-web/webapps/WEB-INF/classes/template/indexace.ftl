...
<#include "acehead.ftl">
    <script src="/static/common/inspinia-ace.js?v=3.2.0"></script>
            ...
            <ul class="nav ace-nav">
                ...
                <li class="purple">
                    ...
                    <ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li class="dropdown-footer">
                            <a class="J_menuItem" href="/oa/oaNotify/self ">
                                查看所有
                ...
                <li class="light-blue">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        <li>
                            <a class="J_menuItem" href="/sys/user/imageEdit">
                        ...
                        <li>
                            <a class="J_menuItem" href="/sys/user/info">
                        ...
                        <li>
                            <a class="J_menuItem" href="/iim/contact/index">
                                <i class="ace-icon fa fa-indent"></i>
                                我的通讯录
                            </a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/iim/mailBox/list">
                        ...
                        <li>
                            <a class="J_menuItem" href="/logout">
...
<script type="text/javascript">
    ...
    function changeStyle(){
        $.get('/theme/default?url='+window.top.location.href,function(result){ window.location.reload();  });
