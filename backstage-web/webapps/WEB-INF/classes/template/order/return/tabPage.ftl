    ...
    <td colspan="5">
       ...
       <div style="display: inline-block; width: 45%">
        ...
        <#else>
            ...
            <a href="${pathurl}&pageNum=${pageInfo.firstPage}&pageSize=${pageInfo.pageSize}<#if storeId??>&storeId=${storeId}</#if><#if memberPhone??>&memberPhone=${memberPhone}</#if><#if memberCardId??>&memberCardId=${memberCardId}</#if><#if orderIdList??>&orderIdList=${orderIdList}</#if><#if reverseIdList??>&reverseIdList=${reverseIdList}</#if><#if status??>&status=${status?c}</#if>">&lt&lt首页&nbsp;</a>&nbsp;
            <a href="${pathurl}&pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}<#if storeId??>&storeId=${storeId}</#if><#if memberPhone??>&memberPhone=${memberPhone}</#if><#if memberCardId??>&memberCardId=${memberCardId}</#if><#if orderIdList??>&orderIdList=${orderIdList}</#if><#if reverseIdList??>&reverseIdList=${reverseIdList}</#if><#if status??>&status=${status?c}</#if>" />&lt上一页</a>
            <#else>
                <a href="${pathurl}&pageNum=${pageInfo.firstPage}&pageSize=${pageInfo.pageSize}<#if storeId??>&storeId=${storeId}</#if><#if memberPhone??>&memberPhone=${memberPhone}</#if><#if memberCardId??>&memberCardId=${memberCardId}</#if><#if orderIdList??>&orderIdList=${orderIdList}</#if><#if reverseIdList??>&reverseIdList=${reverseIdList}</#if><#if status??>&status=${status?c}</#if>">&lt&lt首页&nbsp;</a>&nbsp;
                <a href="${pathurl}&pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}<#if storeId??>&storeId=${storeId}</#if><#if memberPhone??>&memberPhone=${memberPhone}</#if><#if memberCardId??>&memberCardId=${memberCardId}</#if><#if orderIdList??>&orderIdList=${orderIdList}</#if><#if reverseIdList??>&reverseIdList=${reverseIdList}</#if><#if status??>&status=${status?c}</#if>" />&lt上一页</a>
            </#if>
        ...
        <#else>
            <#if isparam??&&isparam="1">
                ...
                <a href="${pathurl}&pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}<#if storeId??>&storeId=${storeId}</#if><#if memberPhone??>&memberPhone=${memberPhone}</#if><#if memberCardId??>&memberCardId=${memberCardId}</#if><#if orderIdList??>&orderIdList=${orderIdList}</#if><#if reverseIdList??>&reverseIdList=${reverseIdList}</#if><#if status??>&status=${status?c}</#if>">下一页&gt&nbsp;</a>&nbsp;
                <a href="${pathurl}&pageNum=${pageInfo.lastPage}&pageSize=${pageInfo.pageSize}<#if storeId??>&storeId=${storeId}</#if><#if memberPhone??>&memberPhone=${memberPhone}</#if><#if memberCardId??>&memberCardId=${memberCardId}</#if><#if orderIdList??>&orderIdList=${orderIdList}</#if><#if reverseIdList??>&reverseIdList=${reverseIdList}</#if><#if status??>&status=${status?c}</#if>" />末页&gt&gt</a>
            <#else>
            <a href="${pathurl}&pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}<#if storeId??>&storeId=${storeId}</#if><#if memberPhone??>&memberPhone=${memberPhone}</#if><#if memberCardId??>&memberCardId=${memberCardId}</#if><#if orderIdList??>&orderIdList=${orderIdList}</#if><#if reverseIdList??>&reverseIdList=${reverseIdList}</#if><#if status??>&status=${status?c}</#if>">下一页&gt&nbsp;</a>&nbsp;
            <a href="${pathurl}&pageNum=${pageInfo.lastPage}&pageSize=${pageInfo.pageSize}<#if storeId??>&storeId=${storeId}</#if><#if memberPhone??>&memberPhone=${memberPhone}</#if><#if memberCardId??>&memberCardId=${memberCardId}</#if><#if orderIdList??>&orderIdList=${orderIdList}</#if><#if reverseIdList??>&reverseIdList=${reverseIdList}</#if><#if status??>&status=${status?c}</#if>" />末页&gt&gt</a>
            </#if>
...
<script>
    ...
    function setEveryPage(everyPage){
        ...
        <#if pageInfo??&&isparam??&&isparam=="1">
            a.href = '${pathurl}&pageSize='+everyPage+'&pageNum='+${pageInfo.pageNum};
        <#else>
                a.href = '${pathurl}&pageSize='+everyPage+'&pageNum='+${pageInfo.pageNum};
        </#if>
        a.setAttribute("onclick",'');
