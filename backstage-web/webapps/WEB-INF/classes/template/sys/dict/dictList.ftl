...
<div class="wrapper wrapper-content">
    <div class="ibox">
        ...
        <#if message??>
            ...
            <div class="row">
                <div class="col-sm-12">
                   <form id="searchForm" modelAttribute="dict" action="/sys/dict/list" method="post" class="form-inline">
                       ...
                       -->
                        <div class="form-group">
                            <span>类型：</span>
                            <input name="type" htmlEscape="false" maxlength="50" class="form-control" <#if type??>value="${type}"</#if>/>
                            <span>描述 ：</span>
                            <input name="description" htmlEscape="false" maxlength="50" class="form-control" <#if description??>value="${description}"<#else>value=""</#if>/>
                        </div>
                    </form>
                    <br/>
                </div>
            ...
            <table id="contentTable" class="table table-striped table-bordered  table-hover table-condensed  dataTables-example dataTable no-footer">
                ...
                <#list pageInfo.list as dict>
                    ...
                    <tr>
                        ...
                        <td>${dict.value}</td>
                        <td><a  href="#" onclick="openDialogView('查看字典', '/sys/dict/form?id=${dict.id}','800px', '500px')">${dict.label}</a></td>
